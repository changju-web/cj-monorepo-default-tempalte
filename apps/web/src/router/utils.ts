...
import { buildHierarchyTree } from '@web/utils/tree'
import { userKey, type DataInfo } from '@web/utils/auth'
import { type menuType, routerArrays } from '@web/layout/types'
...
const IFrame = () => import('@web/layout/frame.vue')
// https://cn.vitejs.dev/guide/features.html#glob-import
const modulesRoutes = import.meta.glob('/src/views/**/*.{vue,tsx}')

// 动态路由
import { getAsyncRoutes } from '@web/api/routes'
