...
import { emitter } from '@web/utils/mitt'
import NProgress from '@web/utils/progress'
import { RouteConfigs } from '../../types'
import { useTags } from '../../hooks/useTag'
import { routerArrays } from '@web/layout/types'
import { onClickOutside } from '@vueuse/core'
import TagChrome from './components/TagChrome.vue'
import { handleAliveRoute, getTopMenu } from '@web/router/utils'
import { useSettingStoreHook } from '@web/store/modules/settings'
import { useMultiTagsStoreHook } from '@web/store/modules/multiTags'
import { usePermissionStoreHook } from '@web/store/modules/permission'
